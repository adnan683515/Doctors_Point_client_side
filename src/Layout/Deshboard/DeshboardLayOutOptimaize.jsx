...
const DeshboardLayOutOptimaize = () => {
    ...
    return (
        <div className="flex sm:h-screen bg-gray-100 overflow-hidden">
            ...
            <div
                className={clsx(
                    "bg-white text-black w-64 space-y-6 px-4 py-6 absolute md:relative inset-y-0 left-0 transform md:translate-x-0 transition-transform duration-200 ease-in-out z-50 shadow-md h-screen",
